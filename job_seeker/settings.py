...
# ============================================
# AI Job Aggregator Custom Settings
# ============================================
...
AI_PROVIDER_PREFERENCE = os.getenv('AI_PROVIDER_PREFERENCE', 'openai')
AI_MODEL = os.getenv('AI_MODEL', 'gpt-4')
AI_EMBEDDING_MODEL = os.getenv('AI_EMBEDDING_MODEL', 'text-embedding-ada-002')
AI_TEMPERATURE = float(os.getenv('AI_TEMPERATURE', '0.3'))
AI_MAX_TOKENS = int(os.getenv('AI_MAX_TOKENS', '2000'))
USE_LOCAL_AI = os.getenv('USE_LOCAL_AI', 'False') == 'True'
