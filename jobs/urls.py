...
urlpatterns = [
    ...
    path('bulk-add-jobs/', views.bulk_add_jobs, name='bulk_add_jobs'),  # New bulk URL
    ...
    path('api/process-urls/', views.process_urls_api, name='process_urls_api'),  # New API endpoint
